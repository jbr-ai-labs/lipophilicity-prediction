...
def main():
    ...
    parser.add_argument('--vocab_path', type=str, default = '../../../data/raw/baselines/jtree/vocab.txt', help='root directory of dataset. For now, only classification.')
    ...
    parser.add_argument('--model_name', type=str, default= 'MPNVAE-h450-L56-d3-beta0.005/model.iter-4', help='name of model files')
