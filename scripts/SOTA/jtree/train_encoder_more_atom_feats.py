...
def main():
    ...
    #set up dataset
    train_dataset = MoleculeDataset(os.path.join(args.dataset, args.file_prefix+'_train.csv'), args)
    test_dataset = MoleculeDataset(os.path.join(args.dataset, args.file_prefix+'_test.csv'), args)
    valid_dataset = MoleculeDataset(os.path.join(args.dataset, args.file_prefix+'_validation.csv'), args)
